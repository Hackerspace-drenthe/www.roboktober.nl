...
1. Leg Architecture Decision Records (ADR) vast voor grotere keuzes in `docs/adr`.
  - Reeds vastgelegd: ADR 0001 (service-layer), ADR 0002 (API-versiebeleid), ADR 0003 (deployment safety policy), ADR 0004 (security baseline policy), ADR 0005 (test strategy governance), ADR 0006 (observability policy), ADR 0007 (data governance policy), ADR 0008 (change management policy) en ADR 0009 (access governance policy).
